...
export default function Finance() {
  ...
  return <div className="finance-app">
    ...
    {data && r && currentScope && !error && <>
      ...
      {section === 'home' && <OwnerOverview report={r} context={data.context} />}
      ...
      {section === 'repairs' && <section className="finance-section"><h2>Repair obligations</h2><DataTable rows={data.workspace.claims.filter(c => c.category === 'repairs')} columns={['description', 'asset_id', 'amount', 'remaining', 'creditor']} /><Link to="/repairs">Existing repair and invoice records</Link></section>}
