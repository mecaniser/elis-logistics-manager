...
export interface Context { tenant_id: number; currency: string; assets: { id: number; name: string; type: string }[]; accounts: Record<string, string>; motive_configured: boolean; home_enabled: boolean }
