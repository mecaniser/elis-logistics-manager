...
class AuthAccount(Base):
    ...
    recovery_email = Column(String(254), nullable=True)
    pending_recovery_email = Column(String(254), nullable=True)
    pending_recovery_token_hash = Column(String(64), nullable=True)
    pending_recovery_expires_at = Column(BigInteger, nullable=True)
    recovery_email_requested_at = Column(BigInteger, nullable=True)
